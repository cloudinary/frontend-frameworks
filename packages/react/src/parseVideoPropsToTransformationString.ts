import { VideoTransformationProps, VideoTransformationNameToParser } from './types';

export const parseVideoPropsToTransformationString = (
  transformationPropsKeyToParser: VideoTransformationNameToParser,
  transformationProps: VideoTransformationProps
): string => {
