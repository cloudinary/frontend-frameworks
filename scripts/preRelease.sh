...
npm version prerelease --no-git-tag-version --prefix ./frameworks/vue/vue3
npm version prerelease --no-git-tag-version --prefix ./frameworks/svelte
...
(cd ./frameworks/vue/vue3 && npm publish --access public)
(cd ./frameworks/svelte && npm publish --access public)
